...
class VGGTask(SubTask):
    ...
    def create_tf(self,mode=0):
        ...
        # if topwk >= 15:
        #     topwk = 15
        # tmp_up = min(topwk + 3, 15)
        # # topps = min(topwk + 2, 19)
        # ps_con = []
        # ws_con = []
        ...
        # tmp_weight_ps = {'matchExpressions': [{'key': 'pspro', 'operator': 'In', 'values': ['0', '1']}]}
        # if 0.765 * self.ps_cpu_base + 0.235 * self.ps_mem_base > 0.667:
        #     tmp_weight_ps = {'matchExpressions': [{'key': 'pspro', 'operator': 'In', 'values': ['0', '1','2']}]}
        # tmp_weight_ws = {'matchExpressions': [{'key': 'wokpro', 'operator': 'In', 'values': ws_con}]}
        #     # {'weight': wkrank, 'preference': {
        ...
        #
        # self.template['spec']['tfReplicaSpecs']['Worker']['template']['spec']['affinity']['nodeAffinity'][
        #     'requiredDuringSchedulingIgnoredDuringExecution']['nodeSelectorTerms'].append(tmp_weight_ws)
        # if 0.79 * self.ws_cpu_base + 0.21 * self.ws_mem_base > 0.672:
        #     ws_con = [str(topwk),str(topwk+1),str(topwk+2)]
        #     tmp_weight_ws = {'matchExpressions': [{'key': 'wokpro', 'operator': 'In', 'values': ws_con}]}
        #     self.template['spec']['tfReplicaSpecs']['Worker']['template']['spec']['affinity']['nodeAffinity'][
        #     'requiredDuringSchedulingIgnoredDuringExecution']['nodeSelectorTerms'].append(tmp_weight_ws)
        # if 0.79 * self.ws_cpu_base + 0.21 * self.ws_mem_base > 0.82:
        #     tmp_weight_ws = {'matchExpressions': [{'key': 'pspro', 'operator': 'In', 'values': ['0', '1']}]}
        #     self.template['spec']['tfReplicaSpecs']['Worker']['template']['spec']['affinity']['nodeAffinity'][
        #         'requiredDuringSchedulingIgnoredDuringExecution']['nodeSelectorTerms'].append(tmp_weight_ws)
        # ranks_node = {}
        # node_r_k = list(node_ranks.keys())
        # for n_r_k in node_r_k:
        #     try:
        #         ranks_node[int(node_ranks[n_r_k])].append(n_r_k)
        #     except Exception as ee22:
        #         ranks_node[int(node_ranks[n_r_k])] = []
        #         ranks_node[int(node_ranks[n_r_k])].append(n_r_k)
        # rnk = list(ranks_node.keys())
        #
        # startk = min(19,topwk+)
        ...
        for jj in range(3):
            if jj == 0:
                ...
                if jj == 1:
                    ...
                    # tmp_weight_ps = {'weight': psrank, 'preference': {
                    #     'matchExpressions': [{'key': 'pspro', 'operator': 'In', 'values': ['2','3']}]}}
                    ...
                    # tmp_weight_ps = {'weight': psrank, 'preference': {
                    #         'matchExpressions': [{'key': 'wokpro', 'operator': 'In', 'values': ['2','3']}]}}
                    # self.template['spec']['tfReplicaSpecs']['PS']['template']['spec']['affinity'][
                    #         'nodeAffinity'][
                    #         'preferredDuringSchedulingIgnoredDuringExecution'].append(tmp_weight_ps)
...
class RESTask(SubTask):
    ...
    def create_tf(self,mode=0):
        ...
        #         if 0.765 * self.ps_cpu_base + 0.235 * self.ps_mem_base > 0.7:
        #             tmp_weight_ps = {
        #                 'matchExpressions': [{'key': 'wokpro', 'operator': 'In', 'values': ['2', '3', '4']}]}
        #             self.template['spec']['tfReplicaSpecs']['PS']['template']['spec']['affinity']['nodeAffinity'][
        #                 'requiredDuringSchedulingIgnoredDuringExecution']['nodeSelectorTerms'].append(tmp_weight_ps)
        #         self.template['spec']['tfReplicaSpecs']['Worker']['template']['spec']['affinity']['nodeAffinity'][
        #             'preferredDuringSchedulingIgnoredDuringExecution'].append(tmp_weight_ws)
        ...
        #             ws_con.append(str(ij))
        #         tmp_weight_ps = {'weight': psrank, 'preference': {
        #             'matchExpressions': [{'key': 'pspro', 'operator': 'In', 'values': ['0','1']}]}}
        #         tmp_weight_ws = {'weight': wkrank, 'preference': {
        #             'matchExpressions': [{'key': 'wokpro', 'operator': 'In', 'values': ws_con}]}}
        #         self.template['spec']['tfReplicaSpecs']['PS']['template']['spec']['affinity']['nodeAffinity'][
        #             'preferredDuringSchedulingIgnoredDuringExecution'].append(tmp_weight_ps)
        ...
        #         topwk = self.ps_replicas + 2
        #         if self.worker_replicas >= self.ps_replicas * 4:
        #             if self.worker_replicas >= 7:
        #                 topwk = self.worker_replicas + 1
        #             else:
        #                 topwk = self.ps_replicas + 4
        #         elif self.worker_replicas >= self.ps_replicas * 3:
        #             if self.worker_replicas >= 7:
