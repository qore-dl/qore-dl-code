...
class VGGTask(SubTask):
    def __init__(self,v1,template_id,ps_replicas,worker_replicas,training_step,batch_size,interval,task_id,rtimes,tag,channel1,channel2,channel3,channel4,channel5,num_layer1,num_layer2,num_layer3,num_layer4,num_layer5,dbhost='192.168.128.10', retry=0, update_min_step=400, step_update=200, update_start=0.25,
                 update_end=0.75, update_delay=2.0):
    ...
    def create_tf(self,cpu_source=2048,mem_source=2048):
...
class RESTask(SubTask):
    def __init__(self,v1,template_id,ps_replicas,worker_replicas,training_step,batch_size,interval,task_id,rtimes,tag,bottle,layer1,layer2,layer3,layer4,channel1,channel2,channel3,channel4,dbhost='192.168.128.10', retry=0, update_min_step=400, step_update=200, update_start=0.25,
                 update_end=0.75, update_delay=2.0):
        SubTask.__init__(self,template_id,ps_replicas,worker_replicas,training_step,batch_size,interval,task_id,rtimes,tag,dbhost,retry,update_min_step,step_update,update_start,update_end,update_delay)
        # SubTask.__init__(self,template_id,ps_replicas,worker_replicas,training_step,batch_size,interval,task_id,rtimes,tag)
        self.channel1 = channel1
...
class RETask(SubTask):
    def __init__(self,v1,template_id,ps_replicas,worker_replicas,training_step,batch_size,interval,task_id,rtimes,tag,stack,channel1,channel2,channel3,channel4,dbhost='192.168.128.10', retry=0, update_min_step=400, step_update=200, update_start=0.25,
                 update_end=0.75, update_delay=2.0):
        SubTask.__init__(self,template_id,ps_replicas,worker_replicas,training_step,batch_size,interval,task_id,rtimes,tag,dbhost,retry,update_min_step,step_update,update_start,update_end,update_delay)
        # SubTask.__init__(self,template_id,ps_replicas,worker_replicas,training_step,batch_size,interval,task_id,rtimes,tag)
        self.channel1 = channel1
...
class DENTask(SubTask):
    def __init__(self,v1,template_id,ps_replicas,worker_replicas,training_step,batch_size,interval,task_id,rtimes,tag,L,k,BC,dbhost='192.168.128.10', retry=0, update_min_step=400, step_update=200, update_start=0.25,
                 update_end=0.75, update_delay=2.0):
        SubTask.__init__(self,template_id,ps_replicas,worker_replicas,training_step,batch_size,interval,task_id,rtimes,tag,dbhost,retry,update_min_step,step_update,update_start,update_end,update_delay)
        # SubTask.__init__(self,template_id,ps_replicas,worker_replicas,training_step,batch_size,interval,task_id,rtimes,tag)
        self.L = L
