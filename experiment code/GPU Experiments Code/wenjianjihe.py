import os
import json
base_file = "/data/tfdata/tfcnn/Dynamicmodulation2/system_info.json"
...
if __name__ == '__main__':
    ...
    for job in aim_job:
        ...
        aim_dir = '/data/tfdata/k8snfs/%s/' % job
        ...
        #         os.remove(aim_file)
        res_file = '/data/tfdata/k8snfs/%s/%s_res.json' % (job, job)
        print(res_file)
    ...
    for i in aim_job0:
        command = 'cp /data/tfdata/k8snfs/%s/%s_res.json /data/tfdata/expn2' % (i,i)
        os.system(command)

    command = 'cp /data/tfdata/tfcnn/Dynamicmodulation2/system_info.json /data/tfdata/expn2/Dynamic.json'
    os.system(command)

    # command = 'cp /tfdata/tfcnn/Opti#mus/system_info.json /tfdata/expn2/Optimus.json'
    # os.system(command)
